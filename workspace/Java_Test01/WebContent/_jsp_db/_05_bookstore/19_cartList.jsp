...
<html lang="ko">
	...
	<body>
		...
		<table border="1">
			...
			<tr>
				<td>
					<input type="button" value="쇼핑계속" onclick="window.location.href='00_shopMain.jsp?center=16_list.jsp?book_kind=<%= book_kind %>'">
				</td>
			</tr>
		</table>
		<%
		...
		%>
		<form method="post" action="00_shopMain.jsp?center=23_buyForm.jsp">
			<table border="1">
				<tr>
					<td width="50">번호</td>
					<td width="300">책이름</td>
				...
				<tr>
					...
					<td width="150">
						...
						<%
						String url = "00_shopMain.jsp?center=21_updateCartForm.jsp?cart_id=" + cartList.getCart_id() + 
				...
				<tr>
					<td colspan="5">
						...
						<input type="button" value="쇼핑계속" onclick="window.location.href='00_shopMain.jsp?center=16_list.jsp?book_kind=<%= book_kind %>'">
						<input type="button" value="장바구니비우기" onclick="window.location.href='00_shopMain.jsp?center=20_cartListDel.jsp?list=all&book_kind=<%= book_kind %>'">
					</td>
				</tr>
			</table>
		</form>
