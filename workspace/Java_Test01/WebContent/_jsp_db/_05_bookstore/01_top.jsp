...
%>
<% if(id == null){ %>
		<a href="00_shopMain.jsp?center=16_list.jsp?book_kind=all">전체목록보기</a>
		<br>
	...
	<% } else { %>
		<a href="00_shopMain.jsp?center=16_list.jsp?book_kind=all">전체목록보기</a>&nbsp;
		<a href="00_shopMain.jsp?center=19_cartList.jsp?book_kind=all">장바구니 보기</a>&nbsp;
		<a href="00_shopMain.jsp?center=25_buyList.jsp">구매목록보기</a>
	...
	<%-- 
	<a href="01_carMain.jsp?center=08_carReserveMain.jsp" 
				style="text-decoration: none">예 약 하 기</a>
	--%>
</body>
</html>