...
%>
	<h3>신간소개</h3>
		...
		<b>
			...
			<a href="00_shopMain.jsp?center=16_list.jsp?book_kind=<%= bookLists[0].getBook_kind() %>">더보기</a>
		</b> 
		<%
		...
		<table border="1">
			<tr height="30">
				<td width="100" rowspan="4" align="center">
					<a href="00_shopMain.jsp?center=17_bookContent.jsp?book_id=<%= bookLists[j].getBook_id() %>&book_kind=<%= bookLists[0].getBook_kind() %>">
						<img width="90" height="120" src="images/<%= bookLists[j].getBook_image() %>">
					</a>
				</td>
				<td width="250">
					<a href="00_shopMain.jsp?center=17_bookContent.jsp?book_id=<%= bookLists[j].getBook_id() %>&book_kind=<%= bookLists[0].getBook_kind() %>">
