			...
			<table border="1">
				<tr height="30">
					<td width="150" rowspan="6">
						<img src="images/<%= bookList.getBook_image() %>" width="150" height="200">
					</td>
					<td width="500">
				...
				<tr>
					<td width="500">
						...
						%>
						<input type="button" value="목록으로" onclick="window.location.href='00_shopMain.jsp?center=16_list.jsp?book_kind=<%= book_kind %>'">
