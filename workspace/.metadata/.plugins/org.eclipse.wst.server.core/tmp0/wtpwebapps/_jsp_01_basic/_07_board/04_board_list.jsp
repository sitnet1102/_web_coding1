...
<body>
	...
	<table border="1" >
		<tr height="40">
			<td align="right" colspan="5"><input type="button" value="글쓰기"
				onclick="location.href='02_board_write.jsp'"></td>
		</tr>
		...
		<tr height="40">
			...
			<td width="100" align="left">
				<%
					...
					%> <a href="05_board_info.jsp?num=<%= bean.getNum() %>"
	...
	<p></p>
			...
			if(count > 0){
				...
				if(startPage > 10){
		%>
			<a href="04_board_list.jsp?pageNum=<%= startPage - 10 %>"> [이전] </a>
		<%
				}
				// 페이징 처리
		...
		%>
			<a href="04_board_list.jsp?pageNum=<%= startPage + 10 %>"> [다음] </a>
		<%
				}
			}
		 %>
