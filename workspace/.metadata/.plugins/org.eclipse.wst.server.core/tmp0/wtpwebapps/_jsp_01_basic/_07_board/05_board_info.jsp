	...
	<table border="1">
		...
		<tr height="40">
			<td align="center" colspan="4">
				...
				<input type="button" value="답글쓰기" onclick="location.href='10_board_reWrite.jsp?num=<%= bean.getNum() %>'">
				<input type="button" value="수정하기" onclick="location.href='06_board_update.jsp?num=<%= bean.getNum() %>'" >
				<input type="button" value="삭제하기" onclick="location.href='08_board_delete.jsp?num=<%= bean.getNum() %>'" >
